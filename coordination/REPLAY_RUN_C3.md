# REPLAY_RUN_C3 — full-system historical replay
Generated 2026-07-02 18:06 UTC by tools/replay_harness.py (THE_STANDARD v1.3 compliant reporting)
...
## Window & config
- Window: 2025-11-10 -> 2025-11-17 (walk); fetch depth 11d (extra = indicator warmup)
- Symbols: BTC,ETH,SOL
...
- Journal entries: 44 | failures: 0 | pre-filter skips: 364
- Entry-event filter: 75 qualifying events | starved by caps: 14 | cooldown-suppressed: 24 | per-symbol calls: {"BTC": 62, "ETH": 62, "SOL": 58}
- Wall time: 134 min
- SCALING MATH: ~0.0 closes per 60 LLM calls at this signal density (0 closes / 182 calls)

## Isolation proof
- Sandbox: bot/data/replay/C3/sandbox (code copy + empty data tree; runner refuses to start outside a marked sandbox)
- Production data diff (bot/data, bot/ml_data, bot/backtest_ml_data, bot/trades.csv; before vs after): 82 paths changed
...
Artifacts: bot/data/replay/C3/replay_trades.csv, run.log, isolation_report.json, sandbox/replay_out/*