# REPLAY_RUN_C2 — full-system historical replay
Generated 2026-07-02 15:50 UTC by tools/replay_harness.py (THE_STANDARD v1.3 compliant reporting)
...
## Window & config
- Window: 2026-04-04 -> 2026-04-11 (walk); fetch depth 11d (extra = indicator warmup)
- Symbols: BTC,ETH,SOL
...
- Net PnL (after fees+funding): $+0.05 on $500 equity | fees paid $0.02
- Final equity: $500.06
- Per-side: {"LONG": {"n": 1, "wins": 1, "wr": 100.0, "pnl": 0.05}}
- Per-regime: {"trending_bull": {"n": 1, "wins": 1, "wr": 100.0, "pnl": 0.05}}

## LLM usage (honest accounting)
- Total LLM calls: 163 (cap 180; cap reached: False)
- Journal entries: 42 | failures: 0 | pre-filter skips: 395
- Entry-event filter: 96 qualifying events | starved by caps: 12 | cooldown-suppressed: 45 | per-symbol calls: {"BTC": 57, "ETH": 61, "SOL": 45}
- Wall time: 108 min
- SCALING MATH: ~0.4 closes per 60 LLM calls at this signal density (1 closes / 163 calls)

## Isolation proof
- Sandbox: bot/data/replay/C2/sandbox (code copy + empty data tree; runner refuses to start outside a marked sandbox)
- Production data diff (bot/data, bot/ml_data, bot/backtest_ml_data, bot/trades.csv; before vs after): 73 paths changed
...
Artifacts: bot/data/replay/C2/replay_trades.csv, run.log, isolation_report.json, sandbox/replay_out/*